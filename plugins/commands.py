...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/asktoyourdad'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/sahadz/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/sahadz/VCPlayerBot'),
